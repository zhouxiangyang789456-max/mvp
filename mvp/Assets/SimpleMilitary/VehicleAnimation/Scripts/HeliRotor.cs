...
namespace SimpleMilitary.VehicleAnimation
{
    ...
    public class HeliRotor : MonoBehaviour
    {
        ...
        private float _step;
        private Quaternion _mainInitialRotation = Quaternion.identity;
        private Quaternion _tailInitialRotation = Quaternion.identity;
        ...
        {
            if (mainRotor != null)
                _mainInitialRotation = mainRotor.localRotation;
            if (tailRotor != null)
                _tailInitialRotation = tailRotor.localRotation;
            if (autoStart)
                isRunning = true;
        ...
        private void ApplyRotation(float deltaTime)
        {
            if (mainRotor != null)
            {
                ...
                mainRotor.localRotation = _mainInitialRotation * Quaternion.AngleAxis(mainAngle, mainAxis.normalized);
            }
            ...
            if (tailRotor != null)
            {
                ...
                tailRotor.localRotation = _tailInitialRotation * Quaternion.AngleAxis(tailAngle, tailAxis.normalized);
            }
        }
    }
}
